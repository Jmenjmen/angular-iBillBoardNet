...
@Component({
  selector: 'app-product-vitaland',
  templateUrl: './product-vitaland.component.html',
  styleUrl: './product-vitaland.component.css'
})
export class ProductVitalandComponent implements OnInit, OnDestroy {
  ...
  async ngOnInit() {
    ...
    this.BtwModule.setData({ product: "land", msg: this.startTime })
  ...
  sendPresenter() {
    const data = { product: "landPresenter" }
